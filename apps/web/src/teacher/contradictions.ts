...
const PROVENANCE_BONUS: Record<RelationOrigin, number> = { regex: 0.15, authored: 0.1, chaperone: 0.05, reading: 0.05, conceptnet: 0.05 };
...
const NEGATION_ORIGIN_WEIGHT: Record<Negation['origin'], number> = { taught: 1, graded: 0.6, reading: 0.5, conceptnet: 0.5 };
